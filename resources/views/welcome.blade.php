...
{{--       <div style="margin-left:auto; margin-right:auto;margin-top:100px; padding:50px; color:rgb(0, 0, 0);width:800px; background-color:#6faeb0">--}}
...
<script>
    ...
    var input = document.querySelector("#phone"),
        errorMap = ["Invalid number", "Неверный код страны", "Введите номер полностью", "Вы указали слишком много цифр", "Invalid number"],
...
//
//
//     var errorMap = ["Неверный номер", "Неверный код страны","Слишком мало цифр", "Слишком много цифр"];
//
//     // var iti = window.intlTelInput(input, {
//     //     utilscript:
